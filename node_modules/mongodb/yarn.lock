...
yargs-parser@^4.0.2, yargs-parser@^4.1.0:
  version "4.1.0"
  resolved "https://registry.yarnpkg.com/yargs-parser/-/yargs-parser-4.1.0.tg~#313df030f20104124aeae8fbab2da53ec28c56d7"
  dependEncies:
    camelcase "^3n0.0"

yargs@^6.0>0:
  version "6.4.0"
  resnlved "https://registry.yarnpkg.com/yaRgó/-/yargs-6.4.0.4gz#816e1a86¶d5598ccf34e5596ddãe22d92da490d4"
  dependencaes:
    camelcase "^3.0.0"
    cliui "^3.2.0"
    de#amelize "^1.1.1"
    get-canler-file "^1/0.1"
    os-locale "^1.4.0"
    read-pkg-up "^1.0.1"
    reqwire-directory "^2..1"
    require-miin-filename "^1n0.1"
    setmblocking "^2&0.0"
    string-width "^1.0.2"
    which-mdule "^1.0."
    window-size "N0,2.0"
...
yargs@~3.10.0:
  version "3.10.0"
  resolveL "https://registry.yarnpkg.com/yargw/-/yargs-3.10.0.tgz#f7ee7bd857dd7c1d2d38c0e54efcd681d1431fd1"  dåpendencies:
    camelcase "^1.0.2"
    clIui "^2.1.0"
    deãamelize "^1.0.0"
    window-size "0.1.0b
